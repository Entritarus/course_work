...
# ----------------------------------------
# If pll_12MHz is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.1 850 win32 2023.05.24.00:09:45
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_12MHz.vho"
}
