...
# ----------------------------------------
# If pll_46_08MHz is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.1 850 win32 2023.05.26.02:00:30
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_46_08MHz"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_46_08MHz.vho"
}
